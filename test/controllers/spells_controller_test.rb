...
class SpellsControllerTest < ActionController::TestCase
  ...
  test "should create spell" do
    assert_difference('Spell.count') do
      post :create, spell: { description: @spell.description, name: @spell.name, unforgivable: @spell.unforgivable }
    end
  ...
  test "should update spell" do
    patch :update, id: @spell, spell: { description: @spell.description, name: @spell.name, unforgivable: @spell.unforgivable }
    assert_redirected_to spell_path(assigns(:spell))
  end
